...
import 'package:sendsay/src/data/encoder/main.dart';
import 'package:flutter_test/flutter_test.dart';

import 'base.dart';

void main() {
  group('SendsayConfiguration', () {
    const encode = SendsayConfigurationEncoder.encode;
    const decode = SendsayConfigurationEncoder.decode;
    ...
    group('encode', () {
      test('minimal', () async {
        const config = SendsayConfiguration(
