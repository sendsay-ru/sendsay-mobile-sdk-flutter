...
void main() {
  group('SendsayConfigurationChange', () {
    const encode = SendsayConfigurationChangeEncoder.encode;
    const decode = SendsayConfigurationChangeEncoder.decode;
    ...
    group('encode', () {
      test('minimal', () async {
        const change = SendsayConfigurationChange(
