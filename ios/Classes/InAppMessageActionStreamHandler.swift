...
public class InAppMessageActionStreamHandler: NSObject, FlutterStreamHandler, InAppMessageActionDelegate {
    ...
    public func inAppMessageShown(message: SendsaySDK.InAppMessage) {
    ...
    public func inAppMessageError(message: SendsaySDK.InAppMessage?, errorMessage: String) {
        _ = handle(action: InAppMessageAction(
            type: .error,
            message: message,
    ...
    public func inAppMessageClickAction(message: SendsaySDK.InAppMessage, button: SendsaySDK.InAppMessageButton) {
        _ = handle(action: InAppMessageAction(
            type: .click,
            message: message,
            button: button
    ...
    public func inAppMessageCloseAction(message: SendsaySDK.InAppMessage, button: SendsaySDK.InAppMessageButton?, interaction: Bool) {
        _ = handle(action: InAppMessageAction(
            type: .close,
            message: message,
            button: button,
