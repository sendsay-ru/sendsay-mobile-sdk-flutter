...
class FlutterInAppContentBlockCarouselCallback : DefaultContentBlockCarouselCallback {
    ...
    func onMessageShown(placeholderId: String, contentBlock: SendsaySDK.InAppContentBlockResponse, index: Int, count: Int) {
    ...
    func onMessagesChanged(count: Int, messages: [SendsaySDK.InAppContentBlockResponse]) {
        let payload: [String: Any?] = [
