...
///
abstract class SendsayPlatform extends PlatformInterface
    implements BaseInterface {
  /// Constructs a [SendsayPlatform].
  SendsayPlatform() : super(token: _token);

  static final Object _token = Object();

  static SendsayPlatform _instance = MethodChannelSendsayPlatform();

  /// The default instance of [SendsayPlatform] to use.
  ///
  /// Defaults to [MethodChannelSendsayPlatform].
  static SendsayPlatform get instance => _instance;

  /// Platform-specific plugins should set this with their own platform-specific
  /// class that extends [SendsayPlatform] when they register themselves.
  static set instance(SendsayPlatform instance) {
  ...
  Future<void> anonymize([
    SendsayConfigurationChange configurationChange =
  ...
  @override
  Future<bool> configure(SendsayConfiguration configuration) async {
    throw UnimplementedError();
  }
