...
class SendsayConfiguration {
  /// Default Sendsay project token
  final String projectToken;

  /// Default Sendsay project authorization token
  final String authorizationToken;

  /// Default Sendsay project base URL
  final String? baseUrl;

  /// Map event types to extra projects. Every event is tracked into default project and all projects based on this mapping
  final Map<EventType, List<SendsayProject>>? projectMapping;

  /// Default properties added to every event tracked to Sendsay
  ...
  /// Defines how often should the SDK track push notification token to Sendsay
  ...
  final AndroidSendsayConfiguration? android;

  /// Platform specific settings for iOS
  final IOSSendsayConfiguration? ios;
...
@immutable
class AndroidSendsayConfiguration {
  ...
  const AndroidSendsayConfiguration({
