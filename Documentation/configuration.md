...
The following parameters are specified in an `SendsayConfiguration` object. Refer to [lib/src/data/model/configuration.dart](https://github.com/sendsay/sendsay-flutter-sdk/blob/main/lib/src/data/model/configuration.dart) for the complete Dart definition.
...
* `authorization` **(required)**
   ...
   * For more information, refer to [Sendsay API documentation](https://docs.sendsay.com/reference#access-keys).

* `baseURL`
  * Your API base URL which can be found in the Engagement web app under `Project settings` > `Access management` > `API`.
  * Default value `https://api.sendsay.com`.
...
* `defaultProperties`
  ...
  * You can change these properties at runtime by calling `SendsayPlugin().setDefaultProperties()`.
...
* `android`
  * `AndroidSendsayConfiguration` object containing [Android-specific configuration parameters](#android-specific-configuration-parameters).

* `ios`
  * `IOSSendsayConfiguration` object containing [iOS-specific configuration parameters](#ios-specific-configuration-parameters).

### Android-specific configuration parameters

The following parameters are specified in an `AndroidSendsayConfiguration` object. Refer to [lib/src/data/model/configuration.dart](https://github.com/sendsay/sendsay-flutter-sdk/blob/main/lib/src/data/model/configuration.dart) for the complete Dart definition
...
The following parameters are specified in an `IOSSendsayConfiguration` object. Refer to [lib/src/data/model/configuration.dart](https://github.com/sendsay/sendsay-flutter-sdk/blob/main/lib/src/data/model/configuration.dart) for the complete Dart definition
