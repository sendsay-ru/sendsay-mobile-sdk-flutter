...
excerpt: Update Sendsay Flutter SDK in your app to a new version
slug: flutter-sdk-version-update
categorySlug: integrations
parentDocSlug: flutter-sdk-release-notes
---

This guide will help you upgrade your Sendsay SDK to the new version.

## Update from version 1.x.x to 2.x.x

Updating the Sendsay Flutter SDK to version 2.X.X from 1.X.X requires making some changes related to in-app messages Action Stream implementations.
...
Updating the Sendsay Flutter SDK to version 1 and higher requires making some changes related to Firebase push notifications.
...
2. Call `SendsayPlugin.handleRemoteMessage` when a message is received.
3. Call `SendsayPlugin.handleNewGmsToken` when a token is obtained.
