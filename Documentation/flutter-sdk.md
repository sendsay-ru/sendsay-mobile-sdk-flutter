...
The SDK is [available as open source on GitHub](https://github.com/sendsay/sendsay-flutter-sdk) for maximum transparency and includes an [example app](https://documentation.bloomreach.com/engagement/docs/flutter-sdk-example-app) you can use as a reference implementation.
