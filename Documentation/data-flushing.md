...
The SDK supports the following 4 flushing modes (defined in [`/lib/src/data/model/flush_mode.dart`](https://github.com/sendsay/sendsay-flutter-sdk/blob/main/lib/src/data/model/flush_mode.dart)) to specify how often or if data is flushed automatically.
